...
SOURCES = {
    ...
    "environment_agency_drought": "https://www.gov.uk/government/publications/dry-weather-and-drought-in-england-2026-summary-reports/dry-weather-and-drought-in-england-18-to-24-september-2026",
...
def build_payload(base_url: str = "") -> dict:
    ...
    return {
        ...
        "headline": {
            ...
            "england_september_rain_pct_lta": 58,
            "england_september_rain_to_date": "22 September 2026",
            "reservoir_storage_pct": 56.4,
            "reservoir_context": "18.6% below average for the time of year; 14 reservoirs or reservoir groups below 50% full and five exceptionally low",
        ...
        "drought": {
            ...
            "england_area_pct": 71,
            "river_flows_below_normal_or_lower_pct": 65,
            ...
            "groundwater_context": "Groundwater levels continue their seasonal decline. Tilshead in the Upper Hampshire Avon Chalk and Chipstead in the Epsom North Downs Chalk are exceptionally low; Jackaments Bottom in the Cotswolds Oolite is notably low, alongside chalk sites in the Wessex Downs, Yorkshire Wolds and South Downs.",
            "abstraction_restrictions": 533,
            "voluntary_abstraction_restrictions": 1383,
            "agriculture_context": "Recent rainfall and the end of peak irrigation have eased some drought pressure, but impacts remain regional and some demand remains for finishing root crops. Cereal yields in the east and south-east were substantially affected by summer heat and drought. Some farm reservoirs and storage are reported at only 0% to 20% capacity, keeping winter refill a concern. There are 533 formal abstraction-licence restrictions and 1,383 voluntary 50% restrictions across Thames, Wye and Severn catchments.",
            "recovery_outlook": {
